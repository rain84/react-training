...
export const ReactMemo = () => {
	...
	const onClick: OnClick<TComponent> = useCallback((e) => setComponentName(e.target.value), [])
...
const propsAreEqual = (prev: LyricsProps, next: LyricsProps) => prev.lyric.id === next.lyric.id
