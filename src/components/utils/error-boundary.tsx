	...
	public render() {
		if (this.state.error) {
			return (
				<>
					<h1>Error caught</h1>
					<button className="border border-violet-700 rounded-lg" onClick={this.onClick}>
						Go home
					</button>
		...
		return <Context.Provider value={this.#setError}>{this.props.children}</Context.Provider>
	}
}
